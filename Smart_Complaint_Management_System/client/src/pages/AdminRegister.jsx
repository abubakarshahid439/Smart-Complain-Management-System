...
import { User, Mail, Lock, ShieldCheck, ArrowRight, ArrowLeft, CheckCircle, Sparkles } from 'lucide-react';
            ...
            <div className="flex-1 h-full overflow-y-auto flex flex-col items-center py-20 p-4 sm:p-8 relative">
                ...
                >
                    <div className="mb-8 flex items-center justify-between">
                        <Link to="/admin/login" className="flex items-center gap-2 text-slate-400 hover:text-emerald-600 font-bold text-sm transition-all group">
                        ...
                        {isSuccess ? (
                            <div className="py-10 text-center relative z-10">
                                ...
                                >
                                    ...
                                    <div className="relative w-20 h-20 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl flex items-center justify-center shadow-xl border-2 border-emerald-100">
                                        <CheckCircle className="text-emerald-500" size={40} />
                                    </div>
                                </motion.div>
                                <h2 className="text-3xl font-black bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent font-outfit mb-4">Request Sent!</h2>
                                <p className="text-slate-500 font-medium leading-relaxed mb-10">
                                    Your admin account application is now <span className="text-emerald-600 font-bold">pending super admin approval</span>.
                                ...
                                >
                                    Back to Admin Login <ArrowLeft size={16} className="rotate-180 group-hover:translate-x-1 transition-transform" />
                                </Link>
                            </div>
                        ) : (
                            <>
                                <div className="flex flex-col items-center mb-8 sm:mb-10 lg:hidden relative z-10">
                                ...
                                <div className="flex flex-col items-center mb-6 sm:mb-8 relative z-10">
                                    <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight font-outfit bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent text-center">Admin Setup</h1>
                                ...
                                <p className="text-center text-slate-500 mt-10 text-sm font-medium relative z-10">
                                    ...
                                    <Link to="/admin/login" className="text-emerald-600 hover:text-emerald-700 font-bold decoration-2 underline-offset-4 hover:underline transition-all">
                                        Log Settings
                                    </Link>
                                </p>
                            </>
